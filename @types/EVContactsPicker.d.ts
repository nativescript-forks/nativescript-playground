...
interface EVCContactsPickerDataSourceProtocol {
}
declare var EVCContactsPickerDataSourceProtocol: {

	prototype: EVCContactsPickerDataSourceProtocol;
};

declare class EVContact extends NSObject implements EVContactProtocol {

	static alloc(): EVContact; // inherited from NSObject

	static new(): EVContact; // inherited from NSObject

	date: Date; // inherited from EVContactProtocol

	dateUpdated: Date; // inherited from EVContactProtocol

	email: string; // inherited from EVContactProtocol

	firstName: string; // inherited from EVContactProtocol

	identifier: string; // inherited from EVContactProtocol

	image: UIImage; // inherited from EVContactProtocol

	lastName: string; // inherited from EVContactProtocol

	phone: string; // inherited from EVContactProtocol

	selected: boolean; // inherited from EVContactProtocol
...
declare var EVContactProtocol: {

	prototype: EVContactProtocol;
};

interface EVContactsPickerDelegate {

	didChooseContacts?(contacts: NSArray<EVContactProtocol>): void;

	shouldShowContact?(contact: EVContactProtocol): boolean;
}
declare var EVContactsPickerDelegate: {

	prototype: EVContactsPickerDelegate;
};
...
declare class EVContactsPickerViewController extends UIViewController implements CNContactViewControllerDelegate, UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate {
	...
	delegate: EVContactsPickerDelegate;
	...
	constructor(o: { externalDataSource: NSArray<EVContactProtocol>; });
	...
	initWithExternalDataSource(externalDataSource: NSArray<EVContactProtocol>): this;
...
declare class EVDataSource extends NSObject {

	static alloc(): EVDataSource; // inherited from NSObject

	static new(): EVDataSource; // inherited from NSObject
}
