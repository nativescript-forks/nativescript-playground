...
declare class BarChartDataEntry extends ChartDataEntry {
	...
	constructor(o: { x: number; yValues: NSArray<number>; });

	constructor(o: { x: number; yValues: NSArray<number>; label: string; });

	calcPosNegSum(): void;

	calcRanges(): void;

	initWithXYValues(x: number, yValues: NSArray<number>): this;

	initWithXYValuesLabel(x: number, yValues: NSArray<number>, label: string): this;
...
declare class BarChartDataSet extends BarLineScatterCandleBubbleChartDataSet implements IBarChartDataSet {
	...
	calcMinMaxWithEntry(e: ChartDataEntry): void;
...
declare class BarChartHighlighter extends ChartHighlighter {
	...
	getClosestStackIndexWithRangesValue(ranges: NSArray<ChartRange>, value: number): number;
...
declare class BarChartView extends BarLineChartViewBase implements BarChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): BarChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): BarChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): BarChartView; // inherited from UIAppearance
...
declare class BarLineChartViewBase extends ChartViewBase implements BarLineScatterCandleBubbleChartDataProvider, UIGestureRecognizerDelegate {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): BarLineChartViewBase; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): BarLineChartViewBase; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): BarLineChartViewBase; // inherited from UIAppearance
...
declare class BubbleChartRenderer extends BarLineScatterCandleBubbleChartRenderer {
	...
	drawDataSetWithContextDataSet(context: any, dataSet: IBubbleChartDataSet): void;
...
declare class BubbleChartView extends BarLineChartViewBase implements BubbleChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): BubbleChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): BubbleChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): BubbleChartView; // inherited from UIAppearance
...
declare class CandleStickChartView extends BarLineChartViewBase implements CandleChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): CandleStickChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): CandleStickChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): CandleStickChartView; // inherited from UIAppearance
...
declare class ChartBaseDataSet extends NSObject implements IChartDataSet {
	...
	setColorsAlpha(colors: NSArray<UIColor>, alpha: number): void;
...
declare class ChartData extends NSObject {
	...
	constructor(o: { dataSets: NSArray<IChartDataSet>; });
	...
	getFirstLeftWithDataSets(dataSets: NSArray<IChartDataSet>): IChartDataSet;

	getFirstRightWithDataSets(dataSets: NSArray<IChartDataSet>): IChartDataSet;
	...
	initWithDataSets(dataSets: NSArray<IChartDataSet>): this;
...
declare class ChartDataEntry extends ChartDataEntryBase {
...
declare class ChartDataRendererBase extends ChartRenderer {
	...
	drawHighlightedWithContextIndices(context: any, indices: NSArray<ChartHighlight>): void;
...
declare class ChartDataSet extends ChartBaseDataSet {
	...
	values: NSArray<ChartDataEntry>;

	constructor(o: { values: NSArray<ChartDataEntry>; });

	constructor(o: { values: NSArray<ChartDataEntry>; label: string; });
...
declare class ChartHighlight extends NSObject {
	...
	constructor(o: { x: number; y: number; dataSetIndex: number; });
	...
	initWithXYDataSetIndex(x: number, y: number, dataSetIndex: number): this;
...
declare class ChartLegend extends ChartComponentBase {
	...
	readonly extraColorsObjc: NSArray<NSObject>;

	extraEntries: NSArray<ChartLegendEntry>;

	readonly extraLabelsObjc: NSArray<NSObject>;
	...
	constructor(o: { colors: NSArray<NSObject>; labels: NSArray<NSObject>; });

	constructor(o: { entries: NSArray<ChartLegendEntry>; });
	...
	initWithColorsLabels(colors: NSArray<NSObject>, labels: NSArray<NSObject>): this;

	initWithEntries(entries: NSArray<ChartLegendEntry>): this;

	resetCustom(): void;

	setCustomWithColorsLabels(colors: NSArray<NSObject>, labels: NSArray<NSObject>): void;

	setCustomWithEntries(entries: NSArray<ChartLegendEntry>): void;

	setExtraWithColorsLabels(colors: NSArray<NSObject>, labels: NSArray<NSObject>): void;
}
...
declare class ChartLegendEntry extends NSObject {
	...
	constructor(o: { label: string; form: ChartLegendForm; formSize: number; formLineWidth: number; formLineDashPhase: number; formLineDashLengths: NSArray<number>; formColor: UIColor; });

	initWithLabelFormFormSizeFormLineWidthFormLineDashPhaseFormLineDashLengthsFormColor(label: string, form: ChartLegendForm, formSize: number, formLineWidth: number, formLineDashPhase: number, formLineDashLengths: NSArray<number>, formColor: UIColor): this;
}
...
declare const enum ChartLegendPosition {
...
declare class ChartMarkerView extends NSUIView implements IChartMarker {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): ChartMarkerView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ChartMarkerView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): ChartMarkerView; // inherited from UIAppearance

	static new(): ChartMarkerView; // inherited from NSObject

	static viewFromXib(): ChartMarkerView;
...
declare class ChartViewBase extends NSUIView implements ChartAnimatorDelegate, ChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): ChartViewBase; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ChartViewBase; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): ChartViewBase; // inherited from UIAppearance
	...
	descriptionTextAlign: NSTextAlignment;
	...
	highlightValueWithXDataSetIndex(x: number, dataSetIndex: number): void;

	highlightValueWithXDataSetIndexCallDelegate(x: number, dataSetIndex: number, callDelegate: boolean): void;

	highlightValueWithXYDataSetIndex(x: number, y: number, dataSetIndex: number): void;

	highlightValueWithXYDataSetIndexCallDelegate(x: number, y: number, dataSetIndex: number, callDelegate: boolean): void;

	highlightValues(highs: NSArray<ChartHighlight>): void;
...
declare class ChartXAxisRenderer extends ChartAxisRendererBase {
	...
	drawLabelWithContextFormattedLabelXYAttributesConstrainedToSizeAnchorAngleRadians(context: any, formattedLabel: string, x: number, y: number, attributes: NSDictionary<string, NSObject>, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: number): void;
...
declare class CombinedChartView extends BarLineChartViewBase implements BarChartDataProvider, BubbleChartDataProvider, CandleChartDataProvider, CombinedChartDataProvider, LineChartDataProvider, ScatterChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): CombinedChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): CombinedChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): CombinedChartView; // inherited from UIAppearance
...
declare class HorizontalBarChartView extends BarChartView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): HorizontalBarChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): HorizontalBarChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): HorizontalBarChartView; // inherited from UIAppearance
...
interface IChartAxisValueFormatter extends NSObjectProtocol {
...
interface IChartHighlighter extends NSObjectProtocol {
...
interface IChartMarker extends NSObjectProtocol {
...
interface IChartValueFormatter extends NSObjectProtocol {
...
interface ILineChartDataSet extends ILineRadarChartDataSet {
	...
	drawCubicEnabled: boolean;

	drawSteppedEnabled: boolean;
...
interface IShapeRenderer extends NSObjectProtocol {
...
declare class LineChartDataSet extends LineRadarChartDataSet implements ILineChartDataSet {
	...
	drawCubicEnabled: boolean; // inherited from ILineChartDataSet

	drawFilledEnabled: boolean; // inherited from ILineRadarChartDataSet

	drawHorizontalHighlightIndicatorEnabled: boolean; // inherited from ILineScatterCandleRadarChartDataSet

	drawSteppedEnabled: boolean; // inherited from ILineChartDataSet
	...
	readonly isDrawCubicEnabled: boolean; // inherited from ILineChartDataSet

	readonly isDrawFilledEnabled: boolean; // inherited from ILineRadarChartDataSet

	readonly isDrawSteppedEnabled: boolean; // inherited from ILineChartDataSet
...
declare class LineChartView extends BarLineChartViewBase implements LineChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): LineChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): LineChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): LineChartView; // inherited from UIAppearance
...
declare class NSUIView extends UIView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NSUIView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NSUIView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NSUIView; // inherited from UIAppearance

	static new(): NSUIView; // inherited from NSObject

	nsuiTouchesBeganWithEvent(touches: NSSet<UITouch>, event: UIEvent): void;

	nsuiTouchesCancelledWithEvent(touches: NSSet<UITouch>, event: UIEvent): void;

	nsuiTouchesEndedWithEvent(touches: NSSet<UITouch>, event: UIEvent): void;

	nsuiTouchesMovedWithEvent(touches: NSSet<UITouch>, event: UIEvent): void;
}
...
declare class PieChartView extends PieRadarChartViewBase {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): PieChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): PieChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): PieChartView; // inherited from UIAppearance
	...
	readonly isDrawSliceTextEnabled: boolean;
...
declare class PieRadarChartViewBase extends ChartViewBase {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): PieRadarChartViewBase; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): PieRadarChartViewBase; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): PieRadarChartViewBase; // inherited from UIAppearance
...
declare class RadarChartView extends PieRadarChartViewBase {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): RadarChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): RadarChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): RadarChartView; // inherited from UIAppearance
...
declare class ScatterChartView extends BarLineChartViewBase implements ScatterChartDataProvider {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): ScatterChartView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ScatterChartView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): ScatterChartView; // inherited from UIAppearance
...
declare class XAxisRendererHorizontalBarChart extends ChartXAxisRenderer {
	...
	drawLabelWithContextFormattedLabelXYAttributesAnchorAngleRadians(context: any, formattedLabel: string, x: number, y: number, attributes: NSDictionary<string, NSObject>, anchor: CGPoint, angleRadians: number): void;
