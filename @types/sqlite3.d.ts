...
declare var sqlite3VersionNumber: number;

declare var sqlite3VersionString: interop.Reference<number>;
...
declare function sqlite3_load_extension(db: interop.Pointer | interop.Reference<any>, zFile: string, zProc: string, pzErrMsg: interop.Pointer | interop.Reference<string>): number;
...
declare function sqlite3_preupdate_count(p1: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_preupdate_depth(p1: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_preupdate_hook(db: interop.Pointer | interop.Reference<any>, xPreUpdate: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: number, p4: string, p5: string, p6: number, p7: number) => void>, p3: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;

declare function sqlite3_preupdate_new(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;

declare function sqlite3_preupdate_old(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;
...
declare function sqlite3_snapshot_cmp(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_snapshot_free(p1: interop.Pointer | interop.Reference<any>): void;

declare function sqlite3_snapshot_get(db: interop.Pointer | interop.Reference<any>, zSchema: string, ppSnapshot: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;

declare function sqlite3_snapshot_open(db: interop.Pointer | interop.Reference<any>, zSchema: string, pSnapshot: interop.Pointer | interop.Reference<any>): number;
