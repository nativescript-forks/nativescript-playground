...
class MainModuleInjector extends import0.NgModuleInjector<import1.MainModule> {
  ...
  _ErrorHandler_3:any;
  _ApplicationInitStatus_4:import5.ApplicationInitStatus;
  _Testability_5:import6.Testability;
  _ApplicationRef__6:import7.ApplicationRef_;
  ...
  constructor(parent:import17.Injector) {
    super(parent,[import18.AppComponentNgFactory],([] as any));
  }
  ...
  get _NgLocalization_10():import8.NgLocaleLocalization {
    if ((this.__NgLocalization_10 == (null as any))) { (this.__NgLocalization_10 = new import8.NgLocaleLocalization(this._LOCALE_ID_9)); }
  ...
  createInternal():import1.MainModule {
    ...
    this._ApplicationInitStatus_4 = new import5.ApplicationInitStatus(this.parent.get(import5.APP_INITIALIZER,(null as any)));
    this._Testability_5 = new import6.Testability(this.parent.get(import22.NgZone));
    this._ApplicationRef__6 = new import7.ApplicationRef_(this.parent.get(import22.NgZone),this.parent.get(import24.Console),this,this._ErrorHandler_3,this,this._ApplicationInitStatus_4,this.parent.get(import6.TestabilityRegistry,(null as any)),this._Testability_5);
    this._ApplicationRef_7 = this._ApplicationRef__6;
    this._MainModule_8 = new import1.MainModule(this._ApplicationRef_7);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import25.ErrorHandler)) { return this._ErrorHandler_3; }
    if ((token === import5.ApplicationInitStatus)) { return this._ApplicationInitStatus_4; }
    if ((token === import6.Testability)) { return this._Testability_5; }
    if ((token === import7.ApplicationRef_)) { return this._ApplicationRef__6; }
    if ((token === import7.ApplicationRef)) { return this._ApplicationRef_7; }
    if ((token === import1.MainModule)) { return this._MainModule_8; }
    if ((token === import26.LOCALE_ID)) { return this._LOCALE_ID_9; }
