...
declare class UIButton extends UIControl implements NSCoding {
	...
	yy_backgroundImageURLForState(state: UIControlState): NSURL;

	yy_cancelBackgroundImageRequestForState(state: UIControlState): void;

	yy_cancelImageRequestForState(state: UIControlState): void;

	yy_imageURLForState(state: UIControlState): NSURL;

	yy_setBackgroundImageWithURLForStateOptions(imageURL: NSURL, state: UIControlState, options: YYWebImageOptions): void;

	yy_setBackgroundImageWithURLForStatePlaceholder(imageURL: NSURL, state: UIControlState, placeholder: UIImage): void;

	yy_setBackgroundImageWithURLForStatePlaceholderOptionsCompletion(imageURL: NSURL, state: UIControlState, placeholder: UIImage, options: YYWebImageOptions, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setBackgroundImageWithURLForStatePlaceholderOptionsManagerProgressTransformCompletion(imageURL: NSURL, state: UIControlState, placeholder: UIImage, options: YYWebImageOptions, manager: YYWebImageManager, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setBackgroundImageWithURLForStatePlaceholderOptionsProgressTransformCompletion(imageURL: NSURL, state: UIControlState, placeholder: UIImage, options: YYWebImageOptions, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setImageWithURLForStateOptions(imageURL: NSURL, state: UIControlState, options: YYWebImageOptions): void;

	yy_setImageWithURLForStatePlaceholder(imageURL: NSURL, state: UIControlState, placeholder: UIImage): void;

	yy_setImageWithURLForStatePlaceholderOptionsCompletion(imageURL: NSURL, state: UIControlState, placeholder: UIImage, options: YYWebImageOptions, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setImageWithURLForStatePlaceholderOptionsManagerProgressTransformCompletion(imageURL: NSURL, state: UIControlState, placeholder: UIImage, options: YYWebImageOptions, manager: YYWebImageManager, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setImageWithURLForStatePlaceholderOptionsProgressTransformCompletion(imageURL: NSURL, state: UIControlState, placeholder: UIImage, options: YYWebImageOptions, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;
}
...
declare class UIImage extends NSObject implements NSSecureCoding, UIAccessibilityIdentification {
	...
	static yy_imageWithColor(color: UIColor): UIImage;

	static yy_imageWithColorSize(color: UIColor, size: CGSize): UIImage;

	static yy_imageWithSizeDrawBlock(size: CGSize, drawBlock: (p1: any) => void): UIImage;

	static yy_imageWithSmallGIFDataScale(data: NSData, scale: number): UIImage;
	...
	yy_isDecodedForDisplay: boolean;
	...
	yy_drawInRectWithContentModeClipsToBounds(rect: CGRect, contentMode: UIViewContentMode, clips: boolean): void;

	yy_hasAlphaChannel(): boolean;

	yy_imageByBlurDark(): UIImage;

	yy_imageByBlurExtraLight(): UIImage;

	yy_imageByBlurLight(): UIImage;

	yy_imageByBlurRadiusTintColorTintModeSaturationMaskImage(blurRadius: number, tintColor: UIColor, tintBlendMode: CGBlendMode, saturation: number, maskImage: UIImage): UIImage;

	yy_imageByBlurSoft(): UIImage;

	yy_imageByBlurWithTint(tintColor: UIColor): UIImage;

	yy_imageByCropToRect(rect: CGRect): UIImage;

	yy_imageByDecoded(): this;

	yy_imageByFlipHorizontal(): UIImage;

	yy_imageByFlipVertical(): UIImage;

	yy_imageByGrayscale(): UIImage;

	yy_imageByInsetEdgeWithColor(insets: UIEdgeInsets, color: UIColor): UIImage;

	yy_imageByResizeToSize(size: CGSize): UIImage;

	yy_imageByResizeToSizeContentMode(size: CGSize, contentMode: UIViewContentMode): UIImage;

	yy_imageByRotate180(): UIImage;

	yy_imageByRotateFitSize(radians: number, fitSize: boolean): UIImage;

	yy_imageByRotateLeft90(): UIImage;

	yy_imageByRotateRight90(): UIImage;

	yy_imageByRoundCornerRadius(radius: number): UIImage;

	yy_imageByRoundCornerRadiusBorderWidthBorderColor(radius: number, borderWidth: number, borderColor: UIColor): UIImage;

	yy_imageByRoundCornerRadiusCornersBorderWidthBorderColorBorderLineJoin(radius: number, corners: UIRectCorner, borderWidth: number, borderColor: UIColor, borderLineJoin: CGLineJoin): UIImage;

	yy_imageByTintColor(color: UIColor): UIImage;

	yy_imageDataRepresentation(): NSData;

	yy_saveToAlbumWithCompletionBlock(completionBlock: (p1: NSURL, p2: NSError) => void): void;
}
...
declare class UIImageView extends UIView {
	...
	yy_cancelCurrentHighlightedImageRequest(): void;

	yy_cancelCurrentImageRequest(): void;

	yy_setHighlightedImageWithURLOptions(imageURL: NSURL, options: YYWebImageOptions): void;

	yy_setHighlightedImageWithURLPlaceholder(imageURL: NSURL, placeholder: UIImage): void;

	yy_setHighlightedImageWithURLPlaceholderOptionsCompletion(imageURL: NSURL, placeholder: UIImage, options: YYWebImageOptions, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setHighlightedImageWithURLPlaceholderOptionsManagerProgressTransformCompletion(imageURL: NSURL, placeholder: UIImage, options: YYWebImageOptions, manager: YYWebImageManager, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setHighlightedImageWithURLPlaceholderOptionsProgressTransformCompletion(imageURL: NSURL, placeholder: UIImage, options: YYWebImageOptions, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setImageWithURLOptions(imageURL: NSURL, options: YYWebImageOptions): void;

	yy_setImageWithURLPlaceholder(imageURL: NSURL, placeholder: UIImage): void;

	yy_setImageWithURLPlaceholderOptionsCompletion(imageURL: NSURL, placeholder: UIImage, options: YYWebImageOptions, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setImageWithURLPlaceholderOptionsManagerProgressTransformCompletion(imageURL: NSURL, placeholder: UIImage, options: YYWebImageOptions, manager: YYWebImageManager, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;

	yy_setImageWithURLPlaceholderOptionsProgressTransformCompletion(imageURL: NSURL, placeholder: UIImage, options: YYWebImageOptions, progress: (p1: number, p2: number) => void, transform: (p1: UIImage, p2: NSURL) => UIImage, completion: (p1: UIImage, p2: NSURL, p3: YYWebImageFromType, p4: YYWebImageStage, p5: NSError) => void): void;
}
